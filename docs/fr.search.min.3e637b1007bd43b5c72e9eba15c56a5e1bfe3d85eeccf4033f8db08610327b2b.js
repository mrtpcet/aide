...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/fr.search-data.min.780a7a8d63812c0b862bbf50bcbcfa16126f56f9224c1436ddbfb2a090cc2b47.js',function(){input.required=false;search();});}
