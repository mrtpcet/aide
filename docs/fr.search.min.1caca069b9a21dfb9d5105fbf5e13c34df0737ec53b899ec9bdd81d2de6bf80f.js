...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/fr.search-data.min.49a6ce119c9692a981e11a207eb42b0458fd75ee0ca2e5728b4293d4a2705c36.js',function(){input.required=false;search();});}
