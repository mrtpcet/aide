...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/fr.search-data.min.e5af249a25a48873c30483e8239f313c5372742567c7d712d4e6b63bbcd8d8ac.js',function(){input.required=false;search();});}
