...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/fr.search-data.min.eb0de33707110c5ddafe0d43ffdaf2cc6a4d46399986afcfa6db67a551dc13ff.js',function(){input.required=false;search();});}
